...
export default function Home() {
    return (
        <>
            ...
            <div className="text-white container mx-auto pb-32 pt-14">
                <h2 className="text-3xl font-bold text-center mb-14">Thanks for helping us</h2>
                <div className="flex gap-5 justify-around">

                    <video src="home_page_video.mp4" controls width={500} muted autoPlay className="rounded-xl"></video>
                </div>
            </div>
